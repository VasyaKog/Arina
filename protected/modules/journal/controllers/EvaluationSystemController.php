...
class EvaluationSystemController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['EvaluationSystem']))
		{
	...
	{
		$dataProvider=new CActiveDataProvider('EvaluationSystem');
	...
	{
		$model=EvaluationSystem::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EvaluationSystem $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='evaluation-system-form')
		{
